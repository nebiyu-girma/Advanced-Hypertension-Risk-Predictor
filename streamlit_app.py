...
def get_treatment_suggestions(input_data: Dict[str, Any], prediction: int, feature_names: List[str]) -> List[str]:
    ...
    if prediction == 1:  # High Risk
        ...
        suggestions.append("🟢 <b>MAINTENANCE:</b> Continue current management strategy")
        suggestions.append("🟢 <b>PREVENTION:</b> Maintain healthy lifestyle habits")
        suggestions.append("🔵 <b>MONITORING:</b> Annual cardiovascular risk assessment")
        ...
        if input_data['physical_activity'] == 0:
            suggestions.append("🟢 <b>LIFESTYLE:</b> Regular physical activity for cardiovascular health")
...
def main():
    ...
    <div class="main-header">
        <h1>🩺 Advanced Hypertension Risk Predictor</h1>
        <p style="margin: 10px 0 0 0; font-size: 1.1rem; opacity: 0.9;">
            AI-powered cardiovascular risk assessment with clinical decision support
        </p>
    </div>
    ''', unsafe_allow_html=True)
    ...
    with col2:
        predict_button = st.button("🔮 Analyze Risk Profile", key="predict")
    ...
    if st.session_state.results:
        ...
        with col2:
            ...
            <div class="metric-card">
                ...
                <div class="metric-label">Low Risk Probability</div>
            </div>
            ''', unsafe_allow_html=True)
        ...
        with col3:
            ...
            <div class="metric-card">
                ...
                <div class="metric-label">High Risk Probability</div>
            </div>
            ''', unsafe_allow_html=True)
        ...
        st.markdown('<div class="section-header"><h2>💊 Clinical Recommendations</h2></div>', unsafe_allow_html=True)
    ...
    with st.expander("🤖 About the AI Model", expanded=False):
        ...
        **Model Details:**
        ...
        - Purpose: Clinical decision support for hypertension risk assessment
        
        **Important Notes:**
        - This model is trained on clinical data and provides probabilistic predictions
        - Results should be interpreted by qualified healthcare professionals
        - Regular model validation and updates are recommended
        - Patient privacy and data security are maintained
        
        **Limitations:**
        - Predictions are based on input features only
        - Does not replace comprehensive clinical assessment
        - May not account for rare conditions or genetic factors
        """)

    # Footer
    st.markdown('''
    <div class="footer">
        <p>🩺 <strong>Advanced Hypertension Risk Predictor</strong></p>
        <p>Powered by AI • Built with Streamlit • Designed for Healthcare Professionals</p>
        <p><small>Version 2.0 | Last Updated: 2024</small></p>
    </div>
    ''', unsafe_allow_html=True)
